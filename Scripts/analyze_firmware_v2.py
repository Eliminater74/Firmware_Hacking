...
def extract_segments(firmware_file):
    ...
    for line in binwalk_output.splitlines():
        if "compressed data" in line or "ARMEB instructions" in line:
            ...
            with open(segment_file, 'rb') as sf:
                ...
                if data.startswith(b'\x1F\x8B'):
                    try:
                        ...
                        with open(os.path.join(segment_dir, f"{segment_file}.decompressed.gzip"), 'wb') as df:
                    ...
                    try:
                        ...
                        with open(os.path.join(segment_dir, f"{segment_file}.decompressed.bzip2"), 'wb') as df:
                            df.write(decompressed_data)
                    ...
                    try:
                        ...
                        with open(os.path.join(segment_dir, f"{segment_file}.decompressed.xz"), 'wb') as df:
                            df.write(decompressed_data)
                    ...
                    try:
                        ...
                        with open(os.path.join(segment_dir, f"{segment_file}.decompressed.lz4"), 'wb') as df:
                            df.write(decompressed_data)
                    ...
                    try:
                        ...
                        with open(os.path.join(segment_dir, f"{segment_file}.decompressed.zlib"), 'wb') as df:
                            df.write(decompressed_data)
