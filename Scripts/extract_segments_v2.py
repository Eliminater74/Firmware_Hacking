            ...
            with open(segment_file, 'rb') as sf:
                ...
                if data[:2] in [b'\x78\x01', b'\x78\x9C', b'\x78\xDA']:
                    try:
                        ...
                        with open(f"{segment_file}.decompressed.zlib", 'wb') as df:
                ...
                try:
                    ...
                    with open(f"{segment_file}.decompressed.bzip2", 'wb') as df:
                        df.write(decompressed_data)
                ...
                try:
                    ...
                    with open(f"{segment_file}.decompressed.lzma", 'wb') as df:
                        df.write(decompressed_data)
